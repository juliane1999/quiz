...
const ResAcc = () => {
 ...
 const questions = [
		{
			questionText: 'How to make a responsive web design layout?',
			answerOptions: [
		...
		{
			questionText: 'How are media queries used?',
			answerOptions: [
		...
		{
			questionText: 'How to make your webpage more accessible?',
			answerOptions: [
